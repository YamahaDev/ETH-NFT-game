...
const SelectCharacter = ({ setCharacterNFT }) => {
    ...
    useEffect(() => {
        ...
        if (gameContract) {
            ...
            // https://goerli.pixxiti.com/nfts/0xe29a0618d077853990cbb4212c96b662d6066fb9/1
            alert(
                `NFT キャラクーが Mint されました -- リンクはこちらです: https://goerli.pixxiti.com/nfts/${
                  gameContract.address.toLowerCase()
                }/${tokenId.toNumber()}`
            );
        }
        };
